...
| **Apple Silicon macOS**    | `large-v3/` (~3 GB) **and** `whisper-ggml/ggml-large-v3-turbo-q5_0.bin` (~575 MB) + `llm/*.gguf` (~2 GB) |
...
python scripts/fetch_whisper_ggml.py     # GGML medium-q5_0 — Apple Silicon only
```
