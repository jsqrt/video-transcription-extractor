...
def build_server(adapter: Optional[PipelineAdapter] = None):
    ...
    @server.tool(
        ...
        description=(
            ...
            "files: <stem>.transcription.md (cleaned flat markdown) and "
            "<stem>.summary.md (when summary_mode is 'ollama'). "
            "file_path must be absolute and point to a supported format."
        ),
    )
