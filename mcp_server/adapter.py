...
class PipelineAdapter:
    ...
    def _validate(self, args: TranscribeArguments) -> tuple[Path, Optional[Path]]:
        ...
        if args.title_style not in ("keywords", "snippet"):
            raise AdapterError(
                "invalid_argument",
                f"title_style must be one of keywords|snippet, got: {args.title_style!r}",
            )
    ...
    def transcribe(
        ...
        summary_options = SummaryOptions(mode=args.summary_mode)
